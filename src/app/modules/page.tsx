      ...
      <section className="py-12 bg-secondary/10 border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: "Total Modules", value: "19", icon: Layers },
              { label: "Categories", value: "7", icon: GitBranch },
              { label: "Install Commands", value: "19", icon: Terminal },
              { label: "Ready to Use", value: "100%", icon: CheckCircle2 },
            ].map((stat, idx) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, y: 20 }}
