...
const directoryStructure = {
  ...
  children: [
      ...
      children: [
        {
          ...
          children: [
            { name: "auth/", type: "folder", icon: Shield },
            { name: "users/", type: "folder", icon: Box },
            { name: "email/", type: "folder", icon: FileText },
            { name: "*.ts", type: "file", color: "text-blue-400", description: "Module index files" },
          ],
        },
        {
          name: "controllers/",
          ...
          children: [
            { name: "index.ts", type: "file", color: "text-blue-400" },
            { name: "*.ts", type: "file", color: "text-blue-400", description: "Route controllers" },
          ],
        },
        {
          name: "services/",
          ...
          children: [
            { name: "index.ts", type: "file", color: "text-blue-400" },
            { name: "*.ts", type: "file", color: "text-blue-400", description: "Service classes" },
          ],
        },
        {
          name: "schemas/",
          ...
          children: [
            { name: "index.ts", type: "file", color: "text-blue-400" },
            { name: "*.ts", type: "file", color: "text-blue-400", description: "Validation schemas" },
          ],
        },
        {
          name: "middleware/",
          ...
          children: [
            { name: "auth.ts", type: "file", color: "text-blue-400", description: "Authentication middleware" },
            { name: "rate-limit.ts", type: "file", color: "text-blue-400", description: "Rate limiting" },
          ],
        },
        {
          name: "utils/",
          ...
          children: [
            { name: "index.ts", type: "file", color: "text-blue-400" },
            { name: "*.ts", type: "file", color: "text-blue-400", description: "Utility functions" },
          ],
        },
        {
          name: "types/",
          ...
          children: [
            { name: "index.ts", type: "file", color: "text-blue-400" },
            { name: "*.ts", type: "file", color: "text-blue-400", description: "Custom types" },
          ],
        },
        { name: "app.ts", type: "file", color: "text-blue-400", description: "Application entry point" },
        { name: "server.ts", type: "file", color: "text-blue-400", description: "Server initialization" },
      ],
    },
    {
      name: "prisma/",
      ...
      children: [
        { name: "schema.prisma", type: "file", color: "text-purple-400", description: "Database schema definition" },
        { name: "seed.ts", type: "file", color: "text-blue-400", description: "Database seeding script" },
      ],
    },
    {
      name: "templates/",
      type: "folder",
      description: "Email and view templates",
      children: [
        { name: "controllers/", type: "folder", description: "Email templates" },
        { name: "services/", type: "folder", description: "Service templates" },
        { name: "*.hbs", type: "file", color: "text-yellow-400", description: "Handlebars templates" },
      ],
    },
    {
      name: "tests/",
    ...
    { name: ".env", type: "file", color: "text-green-400", description: "Environment variables" },
    { name: ".env.example", type: "file", color: "text-green-400", description: "Example env file" },
    { name: "package.json", type: "file", color: "text-yellow-400", description: "Project dependencies" },
    { name: "tsconfig.json", type: "file", color: "text-blue-400", description: "TypeScript config" },
    { name: "servcraft.config.json", type: "file", color: "text-blue-400", description: "ServCraft config" },
    { name: "Dockerfile", type: "file", color: "text-cyan-400", description: "Docker container config" },
    { name: "docker-compose.yml", type: "file", color: "text-cyan-400", description: "Docker services" },
  ],
};
...
function FileTree({ items, depth = 0 }: { items: typeof directoryStructure.children; depth?: number }) {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 rounded-xl bg-[#0d0d14] border border-border"
            >
